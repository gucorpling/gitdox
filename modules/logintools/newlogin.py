...
def donewlogin(theform, userdir, thisscript, action=None):
    ...
    mailme(email, msg, config['email_subject'], config['mail_server_address'], config['mail_server_host'], config['mail_server_port'], config['mail_server_user'], config['mail_server_password'], html=False)
    #
